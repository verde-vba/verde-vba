...
Currently detailed: Sprint 29 / 30 / 31. A planner adding a new sprint
...
demoted during Sprint 31 housekeeping.

## Sprint 3–28 summary index
...
# Sprint 26 / 27 / 28 — (index row に折り畳み済み)
...
skip 判断と F1-F4 table は Sprint 29 (L196-) で execute され、`trigger 全
未成立 → Intentional Pause (2) 再起動` に着地。F1-F4 trigger 定義は本
ファイル内 Sprint 29 L229-234 に保全されており、Sprint 31+ で再参照可能。
...
- **Pause (2) exited 2026-04-21 by Sprint 30** — 再開条件 (a) stakeholder
  ...
  化。本 bullet は Sprint 31 Probes executed 時点で Sprint 30 Follow-ups
  (L620-634) の指示により追記 (書き換えではなく追加)。
